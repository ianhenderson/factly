...
.factory('AuthService', ['$rootScope', '$q', '$window', '$http', '$state', '$location', 'LocalStorage', function($rootScope, $q, $window, $http, $state, $location, LocalStorage){
...
.factory('K', ['$http', '$q', 'LocalStorage', function($http, $q, LocalStorage){
...
.controller('LoginCtrl', ['$scope', 'AuthService', 'Toast', function($scope, AuthService, Toast){
...
.controller('NavCtrl', ['$scope', '$state', '$mdSidenav', 'AuthService', function($scope, $state, $mdSidenav, AuthService){
...
.controller('HomeCtrl', ['$scope', 'K', function($scope, K){
...
.controller('AddWordsCtrl', ['$scope', 'Toast', 'K', function($scope, Toast, K){
